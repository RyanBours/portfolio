...
import { IconNextjs, IconReact } from './Icons';
...
export default function ProjectCard({ name, description, link }: Readonly<ProjectProps>) {
    return (
